...
<a name="ftk"></a>
### Extraction de fichiers à partir d'images disques avec FTK Imager
...
3. Ensuite, compressez vos échantillons de fichiers (2-3 maximum si possible) et soumettez-les à PRONOM. Cela peut se faire de deux façons :
   1. Si les fichiers sont suffisamment petits pour tenir dans un e-mail, ils peuvent être envoyés directement à l'employé qui vous contactera.
   2. Si les fichiers zippés sont trop volumineux, vous pouvez partager votre dossier compressé via SharePoint à l'employé qui vous contactera.
