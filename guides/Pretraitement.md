...
* [Analyse des images disques avec Disk Image Processor](#analyse)
...
* [Soumission de fichiers à PRONOM](#pronom)


<a name="analyse"></a>
## Analyse des images disques avec Disk Image Processor
*Note : Cette section a été rédigée pour Disk Image Processor v1.0.0.*

[Disk Image Processor](https://github.com/CCA-Public/diskimageprocessor) est un outil d'interface utilisateur graphique (GUI) développé pour BitCurator qui se trouve au-dessus de deux scripts Python 3 : diskimageanalyzer.py et diskimageprocessor.py.

Chacun des deux scripts/modes prend un répertoire d'images disques et de fichiers connexes en entrée et crée des sorties standardisées cohérentes ainsi qu'un fichier de descriptions CSV.

En mode analyse, l'outil peut être utilisé pour obtenir une compréhension à haut niveau du contenu d'une collection d'images disques. L'outil survole tous les fichiers d'un répertoire, détermine lesquels sont des images disques, puis pour ceux-ci :
...
* Nom de l'image disque
* Système de fichiers
* Type de date
* Date du rapport
* Date de création d'un fichier
* Dernière date de création/ modification d'un fichier
* Étendue (première et dernière date de création/ modification de fichier)
...
Pour l'extraction de fichiers à partir d'images disques en dehors du processus de rapport, nous utilisons généralement l'un des deux outils d'extraction de fichiers à partir d'images de disques : [Bitcurator](script-de-montage-de-limage-disque) ou [FTK Imager](extraction-de-fichiers-a-partir-dimages-de-disque-avec-ftk-imager).
...
* Dans le menu File, sélectionnez "Add Evidence item...".
...
<a name="hfs"></a>
### Extraction de fichiers à partir d'images disques HFS (Hierarchical File System)
